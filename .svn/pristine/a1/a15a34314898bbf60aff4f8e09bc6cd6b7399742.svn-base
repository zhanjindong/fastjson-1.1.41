...
public class ObjectArraySerializer implements ObjectSerializer {
    ...
    public final void write(JSONSerializer serializer, FieldSerializer parentFieldSerializer, Object object, Object fieldName, Type fieldType)
                                                                                                       throws IOException {
            ...
            for (int i = 0; i < end; ++i) {
                ...
                if (item == null) {
                    ...
                    if (serializer.containsReference(item)) {
                        ...
                        if (clazz == preClazz) {
                            preWriter.write(serializer, null, item, null, null);
                        } else {
                            preClazz = clazz;
