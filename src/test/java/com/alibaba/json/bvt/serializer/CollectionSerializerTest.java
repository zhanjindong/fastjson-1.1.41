...
public class CollectionSerializerTest extends TestCase {
    ...
    public void test_0() throws Exception {
        ...
        listSerializer.write(new JSONSerializer(out), null, Collections.EMPTY_LIST, null, null);
    ...
    public void test_1() throws Exception {
        ...
        CollectionSerializer listSerializer = new CollectionSerializer();
        listSerializer.write(new JSONSerializer(out), null, Collections.singletonList(1), null, null);
    ...
    public void test_2_s() throws Exception {
        ...
        list.add(1);
        list.add(2);
        listSerializer.write(new JSONSerializer(out), null, list, null, null);
