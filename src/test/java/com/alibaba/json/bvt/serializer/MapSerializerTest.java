...
public class MapSerializerTest extends TestCase {
    ...
    public void test_empty_1() throws Exception {
        ...
        mapSerializer.write(new JSONSerializer(out), null, Collections.EMPTY_MAP, null, null);
    ...
    public void test_singleton_1() throws Exception {
        ...
        MapSerializer mapSerializer = new MapSerializer();
        mapSerializer.write(new JSONSerializer(out), null, Collections.singletonMap("A", 1), null, null);
    ...
    public void test_int2_s() throws Exception {
        ...
        map.put("A", 1);
        map.put("B", 2);
        mapSerializer.write(new JSONSerializer(out), null, map, null, null);
    ...
    public void test_string3_s() throws Exception {
        ...
        map.put("A", "1");
        map.put("B", "2");
        mapSerializer.write(serializer, null, map, null, null);
    ...
    public void test_special_s() throws Exception {
        ...
        MapSerializer mapSerializer = new MapSerializer();
        mapSerializer.write(new JSONSerializer(out), null, Collections.singletonMap("A\nB", 1), null, null);
