...
public class JavaBeanSerializerTest extends TestCase {
    ...
    public void test_0_s() throws Exception {
        ...
        serializer.write(new JSONSerializer(out), null, a, null, null);
    ...
    public void test_2_s() throws Exception {
        ...
        serializer.write(new JSONSerializer(out), null, new F(new E(123)), null, null);
    ...
    public void test_3_s() throws Exception {
        ...
        JavaBeanSerializer serializer = new JavaBeanSerializer(F.class);
        serializer.write(new JSONSerializer(out), null, new F(null), null, null);
    ...
    public void test_error_s() throws Exception {
        ...
        try {
            ...
            serializer.write(new JSONSerializer(out), null, new C(), null, null);
    ...
    public void test_error_1_s() throws Exception {
        ...
        try {
            ...
            serializer.write(new JSONSerializer(out), null, new D(), null, null);
        } catch (JSONException e) {
            error = e;
        }
        Assert.assertNotNull(error);
