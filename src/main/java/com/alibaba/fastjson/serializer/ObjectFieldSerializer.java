...
public class ObjectFieldSerializer extends FieldSerializer {
	...
	public void writeValue(JSONSerializer serializer, Object propertyValue) throws Exception {
		...
		if (objectSerializer == null) {
			...
			objectSerializer = serializer.getObjectWriter(runtimeFieldClass);
		}
		...
		if (propertyValue == null) {
			...
			objectSerializer.write(serializer, this, null, fieldInfo.getName(), null);
			return;
		}
		...
		if (valueClass == runtimeFieldClass) {
			objectSerializer.write(serializer, this, propertyValue, fieldInfo.getName(), fieldInfo.getFieldType());
			return;
		}

		ObjectSerializer valueSerializer = serializer.getObjectWriter(valueClass);
		valueSerializer.write(serializer, this, propertyValue, fieldInfo.getName(), fieldInfo.getFieldType());
	}
